...
**Start Channel Hoping:** By Default Scapy don't Support Channel Hoping So,this script only capture the Beacon Frame of Only One Channel. Now Open another terminal (ctrl + shift + N ) and type airodump-ng <**Wireless Interface name** +mon>  example: for me *sudo airmon-ng start wlp3s0mon*    
